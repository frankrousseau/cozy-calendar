...
module.exports = PopoverView = (function(superClass) {
  ...
  PopoverView.prototype.positionPopover = function() {
    var bottom, containerHeight, containerOffset, containerWidth, left, oneRowHeight, popoverHeight, popoverMargin, popoverOverflowWindow, popoverWidth, position, targetLeftBorder, targetOffset, targetWidth, top, topOffset, windowHeight;
...
module.exports = {
    ...
    "sync settings button label": "مزامنة",
...
module.exports = {
    ...
    "screen confirm title": "정말 입니까?",
    "screen confirm description": "팝업에서 변경된 내용이 취소 될 것 입니다.",
    "screen confirm yes button": "저장하지 않음",
    "screen confirm no button": "취소",
...
module.exports = {
    ...
    "sync settings button label": "Synchronizacja",
    ...
    "screen confirm title": "Czy jesteś pewien?",
    "screen confirm description": "Zmiany dokonane w tym popover zostaną utracone.",
    "screen confirm yes button": "Nie zapisuj",
    "screen confirm no button": "Anuluj",
    ...
    "screen delete yes button": "Tak",
    "screen delete no button": "Nie",
...
module.exports = {
    ...
    "screen confirm title": "Tem certeza?",
    "screen confirm description": "A modificação que você fez nesta janela será perdido.",
    "screen confirm yes button": "Não salvar",
    "screen confirm no button": "Cancelar",
    ...
    "screen delete yes button": "Sim",
    "screen delete no button": "Não",
...
module.exports = {
    "calendar list title": "Calendars",
    "sync settings button label": "Sincronizare",
    ...
    "screen confirm title": "Ești sigur?",
    "screen confirm description": "The change you made in this popover will be lost.",
    "screen confirm yes button": "Don't save",
    "screen confirm no button": "Cancel",
    "dont ask again": "Dont ask for confirmation when exiting the popover.",
    "screen delete title": "Delete event",
    "screen delete description": "You are about to delete the event \"%{description}\". Are you sure?",
    "screen delete yes button": "Da",
    "screen delete no button": "Nu",
    "screen guest title empty": "Guest",
    "screen guest title": "%{smart_count} guest |||| %{smart_count} guests",
    "screen guest input placeholder": "Email address",
